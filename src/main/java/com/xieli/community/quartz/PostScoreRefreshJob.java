...
import com.xieli.community.service.ElasticsearchService;
...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static {
        try {
            epoch = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2021-02-11 15:00:00");
        } catch (ParseException e) {
            throw new RuntimeException("初始化果壳纪元失败！", e);
        }
    }
