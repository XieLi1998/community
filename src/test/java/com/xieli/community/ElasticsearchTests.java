...
import com.xieli.community.dao.elasticsearch.DiscussPostRepository;
...
public class ElasticsearchTests {
    ...
    public void testInsert() {
        ...
        post = discussMapper.selectDiscussPostById(242);
        System.out.println(post.toString());
        discussRepository.save(post);
        post = discussMapper.selectDiscussPostById(243);
        System.out.println(post.toString());
        discussRepository.save(post);
    }
    ...
    public void testUpdate() {
        ...
        post.setContent("我是xieli, 我要荣耀黄金了！");
        discussRepository.save(post);
    }
